...
# --- ၇။ ပြင်ဆင်ခြင်း (တစ်ခုချင်းစီ ပြန်ပြင်ရန်) ---
st.divider()
st.subheader("⚙️ စာရင်းများ ပြန်ပြင်ရန်")

if not df.empty:
    for i, row in df.iterrows():
        # Sheet ထဲက Row နံပါတ်ကို တွက်ခြင်း (Syntax မှန်အောင် ပြင်ထားသည်)
...
# --- ၉။ နေ့စဉ်စာရင်းရှင်းရန် (အကုန်ဖျက်ခြင်း) ---
st.divider()
