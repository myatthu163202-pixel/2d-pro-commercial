...
# --- ၅။ Sidebar (Setup - Link တစ်ခါထည့်ပြီးရင် မှတ်ထားပေးမည့်စနစ်) ---
...
try:
    ...
    # Syntax error များကို ဤနေရာတွင် စနစ်တကျ ပြင်ဆင်ထားသည်
...
# စာရင်းအသစ်သွင်းရန် Form (ထိုးသူအမည်၊ ဂဏန်း၊ ပမာဏ၊ အ
